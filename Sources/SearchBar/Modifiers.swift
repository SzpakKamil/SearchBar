...
public extension SearchBar{
    ...
    func searchBarStyle(_ style: SearchBarCornerStyleDefaults = .rounded, textColor: Color? = nil, tint: Color? = nil, tokenBackground: Color? = nil, backgroundColor: Color? = nil) -> SearchBar {
        var copy = self
    ...
    func searchBarStyle(style: SearchBarCornerStyleDefaults = .rounded, textColor: Color? = nil, tint: Color? = nil, backgroundColor: Color? = nil) -> SearchBar {
        var copy = self
