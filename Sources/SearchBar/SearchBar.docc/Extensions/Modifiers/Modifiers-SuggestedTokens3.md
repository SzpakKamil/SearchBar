...
Converts suggestions into tokens.
...
`searchBarSuggestedTokens(_:)` converts `SearchBarSuggestion` objects into tokens. Supported on iOS and visionOS.
...
This converts suggestions to tokens.
